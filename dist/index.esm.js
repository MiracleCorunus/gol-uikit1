...
var Icon$1n = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default.createElement("image", { href: "/logo.png", width: "32" })));
};
...
var Logo$2 = function (_a) {
    ...
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 160 26" }, props),
        React__default.createElement("image", { width: "170", height: "28", href: "/logotipoLight.png" })));
};
...
var Icon$1m = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 512 512" }, props),
        ...
        React__default.createElement("image", { href: "/logo.png", width: "92" }),
        React__default.createElement("defs", null,
...
var Icon$18 = function (props) {
    ...
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 40 40" }, props),
        React__default.createElement("image", { href: "/logo.png", width: "40" })));
};
...
var IconModule = /*#__PURE__*/Object.freeze({
    __proto__: null,
    AccountIcon: Icon$2a,
    AccountFilledIcon: Icon$29,
    AddIcon: Icon$28,
    ArrowBackIcon: Icon$27,
    ArrowDownIcon: Icon$26,
    ArrowDropDownIcon: Icon$25,
    ArrowDropUpIcon: Icon$24,
    ArrowFirstIcon: Icon$23,
    ArrowForwardIcon: Icon$22,
    ArrowLastIcon: Icon$21,
    ArrowUpIcon: Icon$20,
    AutoRenewIcon: Icon$1$,
    BinanceIcon: Icon$1_,
    BinanceChainIcon: Icon$1Z,
    BlockIcon: Icon$2c,
    BnbUsdtPairTokenIcon: Icon$1Y,
    BscScanIcon: Icon$1X,
    ...
    MinusIcon: Icon$1d,
    MoreHorizontalIcon: Icon$1c,
    MoreVerticalIcon: Icon$1b,
    NftIcon: Icon$1a,
    NftFilledIcon: Icon$19,
    NoProfileAvatarIcon: Icon$18,
    OpenNewIcon: Icon$17,
    PancakesIcon: Icon$16,
    PencilIcon: Icon$15,
    PancakeRoundIcon: Icon$14,
    PocketWatchIcon: Icon$13,
    PlayCircleOutlineIcon: Icon$12,
    PredictionsIcon: Icon$11,
    PrizeIcon: Icon$10,
    ProposalIcon: Icon$$,
    RemoveIcon: Icon$_,
    VerifiedIcon: Icon$Z,
    ProgressBunny: Icon$Y,
    PresentCheckIcon: Icon$X,
    PresentWonIcon: Icon$W,
    PresentNoneIcon: Icon$V,
    RedditIcon: Icon$U,
    RefreshIcon: Icon$T,
    ResourcesIcon: Icon$S,
    ResourcesFilledIcon: Icon$R,
    SafePalIcon: Icon$Q,
    SearchIcon: Icon$P,
    SellIcon: Icon$O,
    ShareIcon: Icon$N,
    ...
    SwapVertIcon: Icon$H,
    SyncAltIcon: Icon$G,
    TeamPlayerIcon: Icon$F,
    TelegramIcon: Icon$E,
    TestnetIcon: Icon$D,
    Ticket: Icon$C,
    TicketFillIcon: Icon$B,
    TicketRound: Icon$A,
    TimerIcon: Icon$z,
    TokenPocketIcon: Icon$y,
    TradeIcon: Icon$x,
...
var templateObject_1$13, templateObject_2$y, templateObject_3$e, templateObject_4$a;
...
var templateObject_1$10, templateObject_2$x, templateObject_3$d, templateObject_4$9;
        ...
        React__default.createElement(Flex, { justifyContent: "flex-end" },
            ...
            switchEditingUnits && (React__default.createElement(Flex, { alignItems: "center", pl: "12px" },
                React__default.createElement(SwitchUnitsButton, { scale: "sm", variant: "text", onClick: switchEditingUnits },
                    React__default.createElement(Icon$H, { color: "textSubtle" })))))));
};
...
var templateObject_1$Y, templateObject_2$v, templateObject_3$c, templateObject_4$8;
...
var templateObject_1$T, templateObject_2$u, templateObject_3$b, templateObject_4$7, templateObject_5$4;
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default.createElement(PriceLink, { href: "https://gol.finance/swap?outputCurrency=0x52f6a03a53840c01470f33a0b016e4c3e3dfe796" // 
        , target: "_blank" },
...
var StyledBunnyPlaceholder = styled(Icon$1V)(templateObject_2$q || (templateObject_2$q = __makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n"], ["\n  height: 100%;\n  width: 100%;\n"])));
...
var LinkExternal = function (_a) {
    ...
    return (React__default.createElement(Link, __assign({ external: true }, props),
        children,
        React__default.createElement(Icon$17, { color: props.color ? props.color : "primary", ml: "4px" })));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#b0b0b0", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", backgroundAlt2: "rgba(255, 255, 255, 0.7)", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#f4b400", textDisabled: "#BDC2C4", textSubtle: "#36319b", disabled: "#E9EAEB", gradients: {
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#f4ae01", background: "rgb(34,41,49)", backgroundDisabled: "#3c3742", backgroundAlt: "#27262c", backgroundAlt2: "rgba(39, 38, 44, 0.7)", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#372F47", inputSecondary: "#262130", primaryDark: "#36319b", tertiary: "#353547", text: "#F4EEFF", textDisabled: "#666171", textSubtle: "#B8ADD2", disabled: "#524B63", gradients: {
...
var Progress = function (_a) {
    ...
    return (React__default.createElement(StyledProgress, { "$useDark": useDark, variant: variant, scale: scale },
        showProgressBunny && (React__default.createElement(ProgressBunnyWrapper, { style: { left: stepGuard(primaryStep) + "%" } },
            React__default.createElement(Icon$Y, null))),
...
var footBall = "e8c479a20e57df2a.svg";
...
var getBaseThumbStyles = function (_a) {
    ...
    return "\n  -webkit-appearance: none;\n  background-image: url(" + (isMax ? footBall : footBall) + ");\n  background-color: transparent;\n  border: 0;\n  cursor: " + getCursorStyle + ";\n  width: 24px;\n  height: 32px;\n  filter: " + (disabled ? "grayscale(100%)" : "none") + ";\n  transform: translate(-2px, -2px);\n  transition: 200ms transform;\n\n  &:hover {\n    transform: " + (disabled ? "scale(1) translate(-2px, -2px)" : "scale(1.1) translate(-3px, -3px)") + ";\n  }\n";
};
...
var templateObject_1$v, templateObject_2$l, templateObject_3$9, templateObject_4$6, templateObject_5$3, templateObject_6$2, templateObject_7$2;
...
var Icon = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 128 128" }, props),
        React__default.createElement("svg", { width: "128", height: "128", viewBox: "0 0 128 128", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
            React__default.createElement("image", { href: "images/wait.png" }))));
};
...
var RotatingPancakeIcon = styled(Icon)(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
...
var MountAnimation = keyframes(templateObject_1$Yy || (templateObject_1$Yy = __makeTemplateObject(["\n    0% {\n      bottom: -80vh;\n    }\n    100% {\n      bottom: 0vh;\n    }\n  "], ["\n    0% {\n      bottom: -80vh;\n    }\n    100% {\n      bottom: 0vh;\n    }\n  "])));
var UnmountAnimation = keyframes(templateObject_2$uu || (templateObject_2$uu = __makeTemplateObject(["\n    0% {\n      bottom: 0vh;\n    }\n    100% {\n      bottom: -80vh;\n    }\n  "], ["\n    0% {\n      bottom: 0vh;\n    }\n    100% {\n      bottom: -80vh;\n    }\n  "])));
var DrawerContainer = styled.div(templateObject_4$b || (templateObject_4$b = __makeTemplateObject(["\n  width: 100%;\n  height: 80vh;\n  background-color: ", ";\n  border-top-left-radius: 32px;\n  border-top-right-radius: 32px;\n  position: fixed;\n  animation: ", " 350ms ease forwards;\n  padding-bottom: env(safe-area-inset-bottom);\n  html[data-useragent*=\"TokenPocket_iOS\"] & {\n    padding-bottom: 45px;\n  }\n  z-index: 21;\n  ", "\n"], ["\n  width: 100%;\n  height: 80vh;\n  background-color: ", ";\n  border-top-left-radius: 32px;\n  border-top-right-radius: 32px;\n  position: fixed;\n  animation: ", " 350ms ease forwards;\n  padding-bottom: env(safe-area-inset-bottom);\n  html[data-useragent*=\"TokenPocket_iOS\"] & {\n    padding-bottom: 45px;\n  }\n  z-index: 21;\n  ",
    "\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.backgroundAlt;
}, MountAnimation, function (_a) {
    var isUnmounting = _a.isUnmounting;
    return isUnmounting && css(templateObject_3$ff || (templateObject_3$ff = __makeTemplateObject(["\n      animation: ", " 350ms ease forwards;\n    "], ["\n      animation: ", " 350ms ease forwards;\n    "])), UnmountAnimation);
});
...
var ModalBackButton = function (_a) {
    ...
    return (React__default.createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
        React__default.createElement(Icon$27, { color: "primary" })));
};
...
var DropdownMenu = function (_a) {
    ...
    return (React__default.createElement(Box, __assign({ ref: isBottomNav ? null : setTargetRef }, props),
        ...
        hasItems && (React__default.createElement(StyledDropdownMenu, __assign({ style: styles.popper, ref: setTooltipRef }, attributes.popper, { "$isBottomNav": isBottomNav, "$isOpen": isOpen && ((isBottomNav && showItemsOnMobile) || !isBottomNav) }), items.map(function (_a, itemItem) {
        ...
        React__default.createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            ...
            React__default.createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                ...
                React__default.createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default.createElement(Button, { as: "a", href: "https://gol.finance/swap?outputCurrency=0x52f6a03a53840c01470f33a0b016e4c3e3dfe796", target: "_blank", scale: "sm", endIcon: React__default.createElement(Icon$22, { color: lightColors.backgroundAlt }) }, buyCakeLabel))))));
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(Icon$1n, { className: "mobile-icon" }),
...
var PendingMenuIcon = function () { return (React__default.createElement(MenuIconWrapper, { borderColor: "secondary" },
    React__default.createElement(Icon$T, { color: "secondary", width: "24px", spin: true }))); };
...
var MoreWalletCard = function (_a) {
    ...
    return (React__default.createElement(WalletButton, __assign({ variant: "tertiary" }, props),
        React__default.createElement(Icon$1c, { width: "40px", mb: "8px", color: "textSubtle" }),
    ...
    return (React__default.createElement(ModalContainer, { minWidth: "320px" },
        ...
        React__default.createElement(ModalBody, { width: ["320px", null, "340px"] },
            ...
            React__default.createElement(Box, { p: "24px" },
                ...
                React__default.createElement(Button, __assign({ as: "a", href: "https://golfinance.gitbook.io/golfinance/about-golfinance/get-started/connect-your-wallet-to-golfinance", variant: "subtle", width: "100%" }, getExternalLinkProps()), t("Learn How to Connect"))))));
};
...
export { Icon$29 as AccountFilledIcon, Icon$2a as AccountIcon, Icon$28 as AddIcon, Alert, Icon$27 as ArrowBackIcon, Icon$26 as ArrowDownIcon, Icon$25 as ArrowDropDownIcon, Icon$24 as ArrowDropUpIcon, Icon$23 as ArrowFirstIcon, Icon$22 as ArrowForwardIcon, Icon$21 as ArrowLastIcon, Icon$20 as ArrowUpIcon, Icon$1$ as AutoRenewIcon, BackgroundImage, BalanceInput, GridLayout$1 as BaseLayout, BaseMenu, Icon$1Z as BinanceChainIcon, Icon$1_ as BinanceIcon, Icon$2c as BlockIcon, Icon$1Y as BnbUsdtPairTokenIcon, Box, Breadcrumbs, Icon$1X as BscScanIcon, Icon$1W as BunnyCardsIcon, Icon$1V as BunnyPlaceholderIcon, Button, ButtonMenu$1 as ButtonMenu, ButtonMenuItem, CakePrice$1 as CakePrice, Icon$1R as CalculateIcon, Icon$1U as CameraIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$1S as CardViewIcon, Icon$1T as Cards, GridLayout as CardsLayout, Icon$1P as ChartIcon, Checkbox, Icon$1N as CheckmarkCircleFillIcon, Icon$2e as CheckmarkCircleIcon, Icon$1O as CheckmarkIcon, Icon$1M as ChevronDownIcon, Icon$1L as ChevronLeftIcon, Icon$1K as ChevronRightIcon, Icon$1J as ChevronUpIcon, Icon$1Q as CircleOutlineIcon, ClickableElementContainer, Icon$1I as CloseIcon, Icon$1H as CogIcon, Icon$1G as Coin98Icon, Icon$1E as CommunityFilledIcon, Icon$1F as CommunityIcon, ConnectorNames, Icon$1D as CopyIcon, Icon$1C as CrownIcon, Icon$1B as CurrencyIcon, Dropdown, DropdownMenuItemType, Icon$5 as EarnFillIcon, Icon$1z as EarnFilledIcon, Icon$1A as EarnIcon, Icon$1y as EllipsisIcon, Icon$2d as ErrorIcon, Icon$2 as ExpandIcon, ExpandableButton, ExpandableLabel, FallingBunnies, Icon$h as FarmIcon, Flex, Icon$1w as GithubIcon, Grid, Icon$g as GroupsIcon, Icon$e as HamburgerCloseIcon, Icon$f as HamburgerIcon, Heading, Icon$1v as HelpIcon, Icon$1u as HistoryIcon, Icon$d as HomeIcon, IconButton, Icon$c as IfoIcon, Image, Icon$2b as InfoIcon, InlineMenu, InlineMenuContainer, Input$1 as Input, InputGroup, Icon$1x as InstagramIcon, Icon$1s as LanguageCurrencyIcon, Icon$1t as LanguageIcon, Icon$1r as LaurelLeftIcon, Icon$1q as LaurelRightIcon, Link, LinkExternal, Icon$1p as ListViewIcon, Icon$1o as LoginIcon, Icon$1n as LogoIcon, Icon$1m as LogoRoundIcon, LogoWithTextIcon, Icon$1k as LogoutIcon, Icon$1l as MathWalletIcon, Icon$1j as MedalBronzeIcon, Icon$1i as MedalGoldIcon, Icon$1h as MedalPurpleIcon, Icon$1g as MedalSilverIcon, Icon$1f as MedalTealIcon, Menu$1 as Menu, Message, Icon$1e as MetamaskIcon, Icon$1d as MinusIcon, Modal, ModalBackButton, ModalBody, ModalCloseButton, ModalContainer, ModalHeader, ModalProvider, ModalTitle, Icon$b as MoonIcon, Icon$1c as MoreHorizontalIcon, Icon$a as MoreIcon, Icon$1b as MoreVerticalIcon, Icon$9 as NftFillIcon, Icon$19 as NftFilledIcon, Icon$1a as NftIcon, Icon$18 as NoProfileAvatarIcon, NotificationDot, Icon$17 as OpenNewIcon, Overlay, Icon$14 as PancakeRoundIcon, PancakeToggle, Icon$16 as PancakesIcon, Icon$15 as PencilIcon, Icon$12 as PlayCircleOutlineIcon, Icon$13 as PocketWatchIcon, Icon$8 as PoolIcon, Icon$11 as PredictionsIcon, Icon$X as PresentCheckIcon, Icon$V as PresentNoneIcon, Icon$W as PresentWonIcon, Icon$10 as PrizeIcon, ProfileAvatar, Progress, Icon$Y as ProgressBunny, Icon$$ as ProposalIcon, Radio, Icon$U as RedditIcon, Icon$T as RefreshIcon, Icon$_ as RemoveIcon, ResetCSS, Icon$R as ResourcesFilledIcon, Icon$S as ResourcesIcon, Icon$Q as SafePalIcon, Icon$P as SearchIcon, Icon$O as SellIcon, Icon$N as ShareIcon, Icon$1 as ShrinkIcon, Skeleton, Slider, Icon$M as SmallDotIcon, Spinner, Icon$L as StarFillIcon, Icon$K as StarLineIcon, Step, Stepper, SubMenu, SubMenuContainer, SubMenuItem, SubMenuItems, Icon$7 as SunIcon, Svg, Icon$I as SwapFillIcon, Icon$J as SwapIcon, Icon$H as SwapVertIcon, Icon$G as SyncAltIcon, Tab, ButtonMenu as TabMenu, Table, Tag, Td, Icon$6 as TeamBattleIcon, Icon$F as TeamPlayerIcon, Icon$E as TelegramIcon, Icon$D as TestnetIcon, Text, Textfield as TextField, Th, ThemeSwitcher$1 as ThemeSwitcher, Icon$C as Ticket, Icon$B as TicketFillIcon, Icon$C as TicketIcon, Icon$A as TicketRound, Timeline, Icon$z as TimerIcon, Toggle, TokenImage, TokenPairImage, Icon$y as TokenPocketIcon, TooltipText, Icon$w as TradeFilledIcon, Icon$x as TradeIcon, Icon$3 as TrophyFillIcon, Icon$v as TrophyGoldIcon, Icon$4 as TrophyIcon, Icon$u as TrustWalletIcon, Icon$s as TuneIcon, Icon$t as TwitterIcon, UserMenu, UserMenuDivider, UserMenuItem, Icon$Z as VerifiedIcon, Icon$r as VisibilityOff, Icon$q as VisibilityOn, Icon$p as VolumeOffIcon, Icon$o as VolumeUpIcon, Icon$n as VoteIcon, Icon$i as WaitIcon, Icon$l as WalletConnectIcon, Icon$j as WalletFilledIcon, Icon$k as WalletIcon, Icon$m as WarningIcon, variants$5 as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, status as menuStatus, useDelayedUnmount, BottomDrawer, useKonamiCheatCode, useMatchBreakpoints, useModal, useOnClickOutside, useParticleBurst, useTable, useTooltip, useWalletModal };

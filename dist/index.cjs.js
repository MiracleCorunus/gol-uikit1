...
var Icon$1n = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement("image", { href: "/logo.png", width: "32" })));
};
...
var Logo$2 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 160 26" }, props),
        React__default['default'].createElement("image", { width: "170", height: "28", href: "/logotipoLight.png" })));
};
...
var Icon$1m = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 512 512" }, props),
        ...
        React__default['default'].createElement("image", { href: "/logo.png", width: "92" }),
        React__default['default'].createElement("defs", null,
...
var Icon$18 = function (props) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 40 40" }, props),
        React__default['default'].createElement("image", { href: "/logo.png", width: "40" })));
};
...
var Icon$4 = function (props) {
    return (React__namespace.createElement(Svg, __assign({ viewBox: "0 0 19 17" }, props),
...
var Icon$3 = function (props) {
    return (React__namespace.createElement(Svg, __assign({ viewBox: "0 0 18 20" }, props),
        ...
        React__default['default'].createElement(Flex, { justifyContent: "flex-end" },
            ...
            switchEditingUnits && (React__default['default'].createElement(Flex, { alignItems: "center", pl: "12px" },
                React__default['default'].createElement(SwitchUnitsButton, { scale: "sm", variant: "text", onClick: switchEditingUnits },
                    React__default['default'].createElement(Icon$H, { color: "textSubtle" })))))));
};
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, {
        href: "https://gol.finance/swap?outputCurrency=0x52f6a03a53840c01470f33a0b016e4c3e3dfe796" // 
        , target: "_blank"
    },
        React__default['default'].createElement(Icon$14, { width: "24px", mr: "8px" }),
...
var FallingBunnies = function (_a) {
    ...
    var bunnies = __spreadArray([], Array(count)).map(function (_, index) {
        return (React__default['default'].createElement(Bunny, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
            React__default['default'].createElement(Icon$1n, { width: size, height: size })));
    });
...
var StyledBunnyPlaceholder = styled__default['default'](Icon$1V)(templateObject_2$q || (templateObject_2$q = __makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n"], ["\n  height: 100%;\n  width: 100%;\n"])));
...
var Icon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 128 128" }, props),
        React__default['default'].createElement("svg", { width: "128", height: "128", viewBox: "0 0 128 128", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
            React__default['default'].createElement("image", { href: "images/wait.png" }))));
};
...
// 	}
// `;
// var Container = styled__default['default'].div(templateObject_2$k || (templateObject_2$k = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
// var RotatingPancakeIcon = styled__default['default'](Icon)(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
...
var SpinnerIcon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default['default'].createElement("image", { width: "96", height: "96", href: "/images/help.png" })));
};
...
var ModalBackButton = function (_a) {
    ...
    return (React__default['default'].createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
        React__default['default'].createElement(Icon$27, { color: "primary" })));
};
...
var LangSelector = function (_a) {
    ...
    return (React__default['default'].createElement(Dropdown, { position: dropdownPosition, target: React__default['default'].createElement(Button, { scale: buttonScale, variant: "text", startIcon: React__default['default'].createElement(Icon$1t, { color: color, width: "24px" }) }, !hideLanguage && React__default['default'].createElement(Text, { color: color }, currentLang === null || currentLang === void 0 ? void 0 : currentLang.toUpperCase())) }, langs.map(function (lang) {
        ...
        React__default['default'].createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            ...
            React__default['default'].createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                ...
                React__default['default'].createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default['default'].createElement(Button, { as: "a", href: "https://gol.finance/swap?outputCurrency=0x52f6a03a53840c01470f33a0b016e4c3e3dfe796", target: "_blank", scale: "sm", endIcon: React__default['default'].createElement(Icon$22, { color: lightColors.backgroundAlt }) }, buyCakeLabel))))));
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(Icon$1n, { className: "mobile-icon" }),
...
var NoProfileMenuIcon = function () {
    return (React__default['default'].createElement(MenuIconWrapper, { borderColor: "primary" },
        React__default['default'].createElement(Icon$j, { color: "primary", width: "24px" })));
};
var PendingMenuIcon = function () {
    return (React__default['default'].createElement(MenuIconWrapper, { borderColor: "secondary" },
        React__default['default'].createElement(Icon$T, { color: "secondary", width: "24px", spin: true })));
};
var WarningMenuIcon = function () {
    return (React__default['default'].createElement(MenuIconWrapper, { borderColor: "warning" },
        React__default['default'].createElement(Icon$m, { color: "warning", width: "24px" })));
};
var DangerMenuIcon = function () {
    return (React__default['default'].createElement(MenuIconWrapper, { borderColor: "failure" },
        React__default['default'].createElement(Icon$m, { color: "failure", width: "24px" })));
};
...
var UserMenu = function (_a) {
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(StyledUserMenu, __assign({ ref: setTargetRef }, props),
            ...
            React__default['default'].createElement(Icon$1M, { color: "text", width: "24px" })),
...
var MoreWalletCard = function (_a) {
    ...
    return (React__default['default'].createElement(WalletButton, __assign({ variant: "tertiary" }, props),
        React__default['default'].createElement(Icon$1c, { width: "40px", mb: "8px", color: "textSubtle" }),
...
var WalletCard = function (_a) {
    ...
    return (React__default['default'].createElement(WalletButton, {
    ...
    return (React__default['default'].createElement(ModalContainer, { minWidth: "320px" },
        ...
        React__default['default'].createElement(ModalBody, { width: ["320px", null, "340px"] },
            React__default['default'].createElement(WalletWrapper, { py: "24px", maxHeight: "453px", overflowY: "auto" },
                React__default['default'].createElement(Grid, { gridTemplateColumns: "1fr 1fr" },
                    displayListConfig.map(function (wallet) {
                        return (React__default['default'].createElement(Box, { key: wallet.title },
            ...
            React__default['default'].createElement(Box, { p: "24px" },
                ...
                React__default['default'].createElement(Button, __assign({ as: "a", href: "https://golfinance.gitbook.io/golfinance/about-golfinance/get-started/connect-your-wallet-to-golfinance", variant: "subtle", width: "100%" }, getExternalLinkProps()), t("Learn How to Connect"))))));
};
...
exports.AccountFilledIcon = Icon$29;
exports.AccountIcon = Icon$2a;
exports.AddIcon = Icon$28;
exports.Alert = Alert;
exports.ArrowBackIcon = Icon$27;
exports.ArrowDownIcon = Icon$26;
exports.ArrowDropDownIcon = Icon$25;
exports.ArrowDropUpIcon = Icon$24;
exports.ArrowFirstIcon = Icon$23;
exports.ArrowForwardIcon = Icon$22;
exports.ArrowLastIcon = Icon$21;
exports.ArrowUpIcon = Icon$20;
exports.AutoRenewIcon = Icon$1$;
exports.BackgroundImage = BackgroundImage;
exports.BalanceInput = BalanceInput;
exports.BaseLayout = GridLayout$1;
exports.BaseMenu = BaseMenu;
exports.BinanceChainIcon = Icon$1Z;
...
exports.CheckmarkCircleFillIcon = Icon$1N;
exports.CheckmarkCircleIcon = Icon$2e;
...
exports.Coin98Icon = Icon$1G;
exports.CommunityFilledIcon = Icon$1E;
exports.CommunityIcon = Icon$1F;
exports.CopyIcon = Icon$1D;
exports.CrownIcon = Icon$1C;
exports.CurrencyIcon = Icon$1B;
exports.Dropdown = Dropdown;
exports.EarnFillIcon = Icon$5;
exports.EarnFilledIcon = Icon$1z;
exports.EarnIcon = Icon$1A;
exports.EllipsisIcon = Icon$1y;
exports.ErrorIcon = Icon$2d;
exports.ExpandIcon = Icon$2;
exports.ExpandableButton = ExpandableButton;
exports.ExpandableLabel = ExpandableLabel;
exports.FallingBunnies = FallingBunnies;
exports.FarmIcon = Icon$h;
exports.Flex = Flex;
exports.GithubIcon = Icon$1w;
exports.Grid = Grid;
exports.GroupsIcon = Icon$g;
exports.HamburgerCloseIcon = Icon$e;
exports.HamburgerIcon = Icon$f;
exports.Heading = Heading;
exports.HelpIcon = Icon$1v;
exports.HistoryIcon = Icon$1u;
exports.HomeIcon = Icon$d;
exports.IconButton = IconButton;
exports.IfoIcon = Icon$c;
exports.Image = Image;
exports.InfoIcon = Icon$2b;
exports.InlineMenu = InlineMenu;
exports.InlineMenuContainer = InlineMenuContainer;
exports.Input = Input$1;
exports.InputGroup = InputGroup;
exports.InstagramIcon = Icon$1x;
exports.LanguageCurrencyIcon = Icon$1s;
exports.LanguageIcon = Icon$1t;
exports.LaurelLeftIcon = Icon$1r;
exports.LaurelRightIcon = Icon$1q;
exports.Link = Link;
exports.LinkExternal = LinkExternal;
exports.ListViewIcon = Icon$1p;
exports.LoginIcon = Icon$1o;
exports.LogoIcon = Icon$1n;
exports.LogoRoundIcon = Icon$1m;
exports.LogoWithTextIcon = LogoWithTextIcon;
exports.LogoutIcon = Icon$1k;
exports.MathWalletIcon = Icon$1l;
exports.MedalBronzeIcon = Icon$1j;
exports.MedalGoldIcon = Icon$1i;
exports.MedalPurpleIcon = Icon$1h;
exports.MedalSilverIcon = Icon$1g;
exports.MedalTealIcon = Icon$1f;
exports.Menu = Menu$1;
exports.Message = Message;
exports.MetamaskIcon = Icon$1e;
exports.MinusIcon = Icon$1d;
exports.Modal = Modal;
...
exports.MoonIcon = Icon$b;
exports.MoreHorizontalIcon = Icon$1c;
exports.MoreIcon = Icon$a;
exports.MoreVerticalIcon = Icon$1b;
exports.NftFillIcon = Icon$9;
exports.NftFilledIcon = Icon$19;
exports.NftIcon = Icon$1a;
...
exports.Radio = Radio;
exports.RedditIcon = Icon$U;
exports.RefreshIcon = Icon$T;
exports.RemoveIcon = Icon$_;
exports.ResetCSS = ResetCSS;
exports.ResourcesFilledIcon = Icon$R;
exports.ResourcesIcon = Icon$S;
exports.SafePalIcon = Icon$Q;
exports.SearchIcon = Icon$P;
exports.SellIcon = Icon$O;
exports.ShareIcon = Icon$N;
exports.ShrinkIcon = Icon$1;
exports.Skeleton = Skeleton;
exports.Slider = Slider;
exports.SmallDotIcon = Icon$M;
exports.Spinner = Spinner;
exports.StarFillIcon = Icon$L;
exports.StarLineIcon = Icon$K;
exports.Step = Step;
...
exports.SunIcon = Icon$7;
exports.Svg = Svg;
exports.SwapFillIcon = Icon$I;
exports.SwapIcon = Icon$J;
...
exports.Tag = Tag;
exports.Td = Td;
exports.TeamBattleIcon = Icon$6;
exports.TeamPlayerIcon = Icon$F;
exports.TelegramIcon = Icon$E;
